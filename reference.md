...
| Название | Тип             | Предназначение                                                       |
|----------|-----------------|----------------------------------------------------------------------|
| cancel   | () ⇒ void       | Прекращает действие статус-эффекта.                                  |
| addTicks | (number) ⇒ void | Продлевает действие статус-эффекта на указанное количество тиков.    |
...
| restoreOriginal | () ⇒ void    | Восстанавливает изначальное состояние тайла с момента начала боя. |
